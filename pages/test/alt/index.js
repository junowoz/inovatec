...
// Create the user interface (Navbar, Form to create semester, product card)
// Setup supabase, create a table for our semester
// Implement the CRUD logic for the semester

function App() {
  const [ name, setName ] = useState("");
  const [ description, setDescription ] = useState("");
  const [ semester, setProducts] = useState([]);
