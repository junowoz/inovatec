...
export default function ModalEditar({ project, isEditing }) {
  ...
  const {
    ...
    industryData,
    fetchData,
    updateData, // Nova função para atualizar os dados
  } = useInscreverState();
  ...
  useEffect(() => {
    if (project) {
      ...
      setValue("projectUUID", project.projectUUID);
      ...
      <div>
        <Row className="justify-content-md-center">
          <Tabs
            ...
            id="modal-editar-tabs"
            className="mb-3"
          >
            <Tab eventKey="card1" title="Informações Básicas">
              {/* CARD 1 */}
              <Col>
                <Card className="p-4 mb-3">
                  ...
                  <p>
                    Project UUID:
                    <span className="text-muted"> {project.projectUUID}</span>
                  </p>
                  {/* Nome */}
            ...
            {/* CARD 2 */}
            <Tab eventKey="card2" title="Informações Específicas">
              <Row>
                <Card className="p-4 mb-3">
                  <Card.Title className="text-primary pb-2">
            ...
            {/* CARD 3 */}
            <Tab eventKey="card3" title="Recursos Visuais">
              <Row>
                <Card className="p-4 mb-3">
                  <Card.Title className="text-primary pb-2">
                    Recursos Visuais
            ...
            {/* CARD 4 */}
            <Tab eventKey="card4" title="Membros">
              <Row>
                <Card className="p-4 mb-3">
                  <Card.Title className="text-primary pb-2">Membros</Card.Title>
