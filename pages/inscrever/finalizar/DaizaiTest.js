...
import { useMemberState } from "context/useMemberState";
...
export default function InscreverFinalizar() {
  ...
  const { leaderMember, setLeaderMember, deleteLeaderMember, changeFounder } =
    useMemberState();
  ...
  // ALTERAR funder
  const handleFounderChange = (index, isFounder) => {
    const updatedLeaderMember = [...leaderMember];
    updatedLeaderMember[index].isFounder = isFounder;
                          ...
                          <Col>
                            <ButtonGroup className="w-100">
                              <ToggleButton
                                ...
                                onChange={() =>
                                  handleFounderChange(index, true)
                                }
                                {...register(
                              ...
                              <ToggleButton
                                ...
                                checked={!item.isFounder}
                                onChange={() =>
                                  handleFounderChange(index, false)
                                }
